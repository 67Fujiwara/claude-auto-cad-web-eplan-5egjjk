...
const SYMBOLS = [
  ...
  },
  {
    ...
    sim: "none", bounds: [-6,-2, 12, 13],
    /* 横棒は 8 / 5.33 / 2.67 (比 1 : 2/3 : 1/3 を厳密に)・間隔 2mm (= 最長棒の 1/4)。
       導体や機器に対して大きすぎない寸法 (接地群 4 記号で比率をそろえる) */
    body: `<path d="M0,0 V5 M-4,5 H4 M-2.67,7 H2.67 M-1.33,9 H1.33"/>`,
  },
